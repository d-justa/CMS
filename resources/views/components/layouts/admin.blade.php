...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable
        ...
        <flux:navlist variant="outline">
            <flux:navlist.item icon="home" :href="route('dashboard')" :current="Route::is('dashboard')">Dashboard
            </flux:navlist.item>
            <flux:navlist.item icon="check-badge" :href="route('roles.index')" :current="Route::is('roles.*')">Roles
            </flux:navlist.item>
            <flux:navlist.item icon="users" :href="route('users.index')" :current="Route::is('users.*')">Users
            </flux:navlist.item>
